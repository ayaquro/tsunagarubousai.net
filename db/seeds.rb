...
posts=Post.create!(
  [
    {posted_title: '山崩れ', posted_image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/山崩れ.jpg"), filename:"山崩れ.jpg"), posted_text: '山が崩れています。', lat: '37.043355279858', lng: '140.793394115692', general_user_id: general_users[0].id, district_id: districts[0].id },
    {posted_title: '土砂崩れ', posted_image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/土砂崩れ.jpg"), filename:"土砂崩れ.jpg"), posted_text: '土砂崩れが起きています。', lat: '37.026020693886', lng: '140.832189586883', general_user_id: general_users[1].id, district_id: districts[1].id },
    {posted_title: '法面崩壊', posted_image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/法面崩壊.jpg"), filename:"法面崩壊.jpg"), posted_text: '法面が崩壊して通行できなくなっています。', lat: '36.9780537719365', lng: '140.959924426799', general_user_id: general_users[2].id, district_id: districts[2].id },
    {posted_title: '壊れそうな石垣', posted_image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/石垣.jpg"), filename:"石垣.jpg"), posted_text: '所々割れているところがあり危ないです。', lat: '36.9622988235118', lng: '140.946824517971', general_user_id: general_users[3].id, district_id: districts[3].id },
    {posted_title: '道路の隆起', posted_image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/道路の隆起.jpg"), filename:"道路の隆起.jpg"), posted_text: '道路が隆起して、通れません。', lat: '36.9673329611857', lng: '140.899137523895', general_user_id: general_users[4].id, district_id: districts[0].id },
    {posted_title: '台風で倒れた木', posted_image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/台風で倒れた木.jpg"), filename:"台風で倒れた木.jpg"), posted_text: '昨日の台風で倒れたようです。', lat: '36.941320738955', lng: '140.922183063751', general_user_id: general_users[5].id, district_id: districts[1].id },
    {posted_title: '台風による増水', posted_image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/台風による増水.jpg"), filename:"台風による増水.jpg"), posted_text: '川が増水しています。', lat: '37.0468670653286', lng: '140.906830099349', general_user_id: general_users[6].id, district_id: districts[2].id }
  ]
  )
